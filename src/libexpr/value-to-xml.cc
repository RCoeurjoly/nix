...
static void printValueAsXML(EvalState & state, bool strict, bool location,
    Value & v, XMLWriter & doc, StringContext & context, PathSet & drvsSeen,
    const PosIdx pos);
...
static void showAttrs(EvalState & state, bool strict, bool location,
    const Bindings & attrs, XMLWriter & doc, StringContext & context, PathSet & drvsSeen)
{
    StringSet names;
...
void ExternalValueBase::printValueAsXML(EvalState & state, bool strict,
    bool location, XMLWriter & doc, StringContext & context, PathSet & drvsSeen,
...
void printValueAsXML(EvalState & state, bool strict, bool location,
    Value & v, std::ostream & out, StringContext & context, const PosIdx pos)
{
