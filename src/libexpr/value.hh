...
class ExternalValueBase
{
     ...
     * error.
     */
    virtual std::string coerceToString(EvalState & state, const PosIdx & pos, StringContext & context, bool copyMore, bool copyToStore) const;
    ...
    virtual nlohmann::json printValueAsJSON(EvalState & state, bool strict,
        StringContext & context, bool copyToStore = true) const;

    /**
     * Print the value as XML. Defaults to unevaluated
     */
    virtual void printValueAsXML(EvalState & state, bool strict, bool location,
        XMLWriter & doc, StringContext & context, PathSet & drvsSeen,
...
public:
    ...
    void mkString(std::string_view s, const StringContext & context);

    void mkStringMove(const char * s, const StringContext & context);
